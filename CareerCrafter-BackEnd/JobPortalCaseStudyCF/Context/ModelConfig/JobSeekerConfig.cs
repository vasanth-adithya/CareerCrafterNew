...
namespace JobPortalCaseStudyCF.Context.ModelConfig
{
    public class JobSeekerConfig : IEntityTypeConfiguration<JobSeeker>
    {
        public void Configure(EntityTypeBuilder<JobSeeker> builder)
        {
            ...
            builder.Property(j => j.Description).HasColumnName("Description").HasColumnType("nvarchar(100)").IsRequired(false);
            ...
            builder.Property(j => j.Address).HasColumnName("Address").HasColumnType("nvarchar(100)").IsRequired(false);
            builder.Property(j => j.Qualification).HasColumnName("Qualification").HasColumnType("nvarchar(100)").IsRequired(false);
            builder.Property(j => j.Specialization).HasColumnName("Specialization").HasColumnType("nvarchar(100)").IsRequired(false);
            builder.Property(j => j.Institute).HasColumnName("Institute").HasColumnType("nvarchar(100)").IsRequired(false);
            builder.Property(j => j.Year).HasColumnName("Year").HasColumnType("int").IsRequired(false);
            builder.HasCheckConstraint("CHK_Year", "Year >= 1950 AND Year <= 2024");
            builder.Property(j => j.CGPA).HasColumnName("CGPA").HasColumnType("decimal(4,2)").IsRequired(false);
            builder.HasCheckConstraint("CHK_CGPA", "CGPA >= 0.0 AND CGPA <= 10.0");
            builder.Property(j => j.CompanyName).HasColumnName("CompanyName").HasColumnType("nvarchar(100)").IsRequired(false);
            builder.Property(j => j.Position).HasColumnName("Position").HasColumnType("nvarchar(100)").IsRequired(false);
            builder.Property(j => j.Responsibilities).HasColumnName("Responsibilities").HasColumnType("nvarchar(100)").IsRequired(false);
            builder.Property(j => j.StartDate).HasColumnName("StartDate").HasColumnType("datetime").IsRequired(false);
            builder.Property(j => j.EndDate).HasColumnName("EndDate").HasColumnType("datetime").IsRequired(false);
